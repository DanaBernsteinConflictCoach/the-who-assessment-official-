...
function stepDefine(){
  ...
  wrap.appendChild(help(
    ...
    "Your WHO is your authentic inner identity, built from your Values, Pillars, and Ideal Emotion. These powerful inner drivers shape every choice and response.\n\n" +
